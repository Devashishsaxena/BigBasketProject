                ...
                <div className='container-fluid'>
                    <div className='row'>
                        <div className='Header'>
                            <h2 className='hello'>Update Product</h2>
                        ...
                        <div className='col-lg-5 col-md-12'>
                            <div className='card'>
                                <div className='card-header bg-primary'>
                                    <h3 className='text-white'>Selected Product</h3>
                                </div>
                                <div className='card-body'>
                                    <form>
                                        <div className='mb-3'>
                                            <input type='text' className='form-control' placeholder='Potatos' />
                                        </div>
                                        ...
                                        <div className='mb-3'>
                                            <textarea className='form-control' placeholder='for Curry'></textarea>
                                        </div>
                                        <button type='submit' className='bg-dark'>Update</button>
                                    </form>
                                </div>
                                <div >
                                </div>
